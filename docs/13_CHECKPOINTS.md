...
| ---------------------------------- | ---------- | --------------------------------------------------------- |
| `20260529_human_nature_trade_pain` | ⚠️ APPLIED | Local dev only; not yet applied to staging or production. |
...
14. **#125 P1: Run live market-evidence QA** — 7+ human-nature scenarios across Coffee/Cashew/Rice categories; document per case: product, role, human pull, hidden pain, power/dependency, evidence strength, missing proof, recommendation, buyer decision, outcome
15. **#125 → #124**: After #125 live QA, run real production #124 with real magic link, real buyer feedback, documented outcome

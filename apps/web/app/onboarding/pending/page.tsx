export default function PendingOnboardingPage() {
  return (
    <main style={{ padding: 32, fontFamily: 'Arial, sans-serif' }}>
      ...
      <p>Your Supabase account is signed in, but your email is not mapped to a TradeOS organization yet.</p>
      <p>Ask an admin to create a row in the TradeOS User table with your email, organizationId, and role.</p>
